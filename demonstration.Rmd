...
Cheat sheets available at <https://rstudio.com/resources/cheatsheets/>
We will look at an example of using the cheatsheet to achieve an objective with `purrr`
